...
import kr.ac.hansung.cse.dto.Covid19Inf.ApiDTO;
import kr.ac.hansung.cse.dto.Covid19Sido.ItemDTO;
...
public class HomeController {
	...
	private static ApiDTO InfDTO = null;
	private static kr.ac.hansung.cse.dto.Covid19Sido.ApiDTO SidoDTO = null;
	...
	public String coronaCurrent(Model model, HttpServletRequest request) throws Exception {
		...
		if(SidoDTO==null) {		// 싱글턴 패턴
			...
			if (list != null && list.length != 0) {
				for (kr.ac.hansung.cse.dto.Covid19Sido.ItemDTO item : list) {
	...
	public kr.ac.hansung.cse.dto.Covid19Sido.ApiDTO getCovid19Sido(String toDay) throws Exception { // 테스트용
		...
		try {
			...
			mapper.enable(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT);
			mapper.enable(SerializationFeature.INDENT_OUTPUT);
			kr.ac.hansung.cse.dto.Covid19Sido.ApiDTO api = mapper.readValue(jObject.toString(), kr.ac.hansung.cse.dto.Covid19Sido.ApiDTO.class);
