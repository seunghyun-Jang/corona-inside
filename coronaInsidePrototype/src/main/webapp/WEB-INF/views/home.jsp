	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<div class="row justify-content-center">
				<!-- Item 1-->
				<button class="col-md-4 col-lg-4 mb-5"
					onclick="location.href='corona'">
				...
				<button class="col-md-4 col-lg-4 mb-5"
					...
					<div class="portfolio-item mx-auto" data-toggle="modal"
						...
						<img class="img-fluid" src="resources/assets/img/item/vaccine.svg"
							alt="" />
					</div>
					<br>
					<h2 class="masthead-heading text-center text-secondary mb-0">백신
						현황</h2>
				</button>
				<!-- Item 3-->
				<button class="col-md-4 col-lg-4 mb-5"
