...
<body id="page-top">
	...
	<header class="masthead bg-violet text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5"
				src="resources/assets/img/covid.svg" alt="" />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Corona Inside</h1>
			<!-- Icon Divider-->
			<div class="divider-custom divider-light">
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Hong.C.H -
				Jang.S.H - DdoSol</p>
		</div>
	</header>
	<!-- Menu Section-->
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<div class="row justify-content-center">
				<!-- Item 1-->
				<button class="col-md-5 col-lg-5 mb-5"
					onclick="location.href='coronaCurrent'">
					<div class="portfolio-item mx-auto">
						<div
						...
						<img class="img-fluid"
							src="resources/assets/img/item/covidcurrent.svg" alt="" />
					</div>
					<br>
					<h2 class="masthead-heading text-center text-secondary mb-0">코로나
						현황</h2>
				</button>
				<!-- Item 2-->
				<button class="col-md-5 col-lg-5 mb-5"
					...
					<div class="portfolio-item mx-auto" data-toggle="modal"
						...
						<img class="img-fluid"
							src="resources/assets/img/item/community.svg" alt="" />
					</div>
					<br>
					<h2 class="masthead-heading text-center text-secondary mb-0">커뮤니티</h2>
				</button>
				<!-- Item 3-->
				<button class="col-md-5 col-lg-5 mb-5 mb-lg-0"
					onclick="location.href='selfcheck'">
					<div class="portfolio-item mx-auto" data-toggle="modal"
						...
						<img class="img-fluid" src="resources/assets/img/item/test2.svg"
							alt="" />
					</div>
					<br>
					<h2 class="masthead-heading text-center text-secondary mb-0">방역점수
						셀프체크</h2>
				</button>
				<!-- Item 4-->
				<button class="col-md-5 col-lg-5" onclick="location.href='faq'">
					<div class="portfolio-item mx-auto" data-toggle="modal"
						...
						<img class="img-fluid" src="resources/assets/img/item/faq2.svg"
							alt="" />
					</div>
					<br>
					<h2 class="masthead-heading text-center text-secondary mb-0">FAQ</h2>
...
>>>>>>> 7542fa158f9c7e9cde33150deee837008a4bc128
</html>
